...
object Tests {
  ...
  Parser[WithHelp[NoArgs]]
  Parser[WithHelp[FewArgs]]
  Parser[WithHelp[MoreArgs]]
  Parser[WithHelp[WithList]]
  Parser[WithHelp[WithTaggedList]]
  Parser[WithHelp[WithCalendar]]

  Parser[WithHelp[Demo]]
...
class Tests extends FlatSpec with Matchers {
  ...
  it should "parse semi-colon separated list args" in {
    val parser = Parser[WithTaggedList]
  ...
  it should "parse a date" in {
    val parser = Parser[WithCalendar]
